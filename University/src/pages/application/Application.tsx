    ...
    return (
      <div className='tutorial'>
        <div className='tutorial__step'>
          ...
          <p><strong>Step 1:</strong>Please fill in details of your Document Details</p>
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Form.Group controlId='drivingLicense'>
              <Form.Label style={{margin: '10px 0 0 0'}}>Document Description(eg: 10th marksheet):</Form.Label>
            ...
            <div style={{margin: '30px 0'}}>
              <p><strong>Step 2:</strong>Upload Proof of Document</p>
              <Form.File id="formcheck-api-regular">
                <Form.File.Label>Proof of Document</Form.File.Label>
                <Form.File.Input />
                <Form.Control.Feedback type="invalid"> Please provide proof of your Document. </Form.Control.Feedback>
              </Form.File>
            </div>
