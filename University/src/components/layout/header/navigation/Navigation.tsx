  ...
  return (
    ...
    >
      <Container>
        <NavbarBrand>
          <Link to={routes.ROOT}>
            <p className="brand">&#127891; DecentDocs</p>
          </Link>
        </NavbarBrand>
        ...
        <Navbar.Collapse className={showNavbar ? 'show' : ''}>
          <Nav className="justify-content-end">
            ...
            {!appState.isAuthenticated && (
              <>
                <Nav.Item>
                  <Nav.Link as={NavLink} className="navItem" activeClassName='is-active' to={routes.APPLICANT_LOGIN}>Start applying Document</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link as={NavLink} className="navItem" activeClassName='is-active' to={routes.ISSUER_LOGIN}>Sign in as admin</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link as={NavLink} className="navItem" activeClassName='is-active' to={routes.API_KEY}>API Key</Nav.Link>
                </Nav.Item>
              </>
            )}
          </Nav>
